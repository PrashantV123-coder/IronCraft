...
const YourProducts = () => {
  ...
  const grill = useSelector((state) => state.design.urls.grill || {});
  const window = useSelector((state) => state.design.urls.window || {});
  const ladder = useSelector((state) => state.design.urls.ladder || {});
